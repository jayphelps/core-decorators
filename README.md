...
These are stage-0 decorators because while [the decorators spec has changed](https://github.com/wycats/javascript-decorators/blob/master/interop/reusability.md) and is now stage-1, no transpiler is yet to implement these changes and until they do, this library won't either.
